...
const remove = (schedule: Schedule) => {
    if (confirm(`Remover a recorrência ${schedule.description ?? ''}?`)) {
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <EmptyState v-else class="mt-8" :icon="Repeat" title="Automatize seus lançamentos" description="Crie recorrências para contas, salários e assinaturas." />
  </AuthenticatedLayout>
</template>
