...
<template>
  ...
  <AuthenticatedLayout>
    <PageHeader kicker="Investimentos" title="Corretoras" subtitle="Instituições vinculadas ao histórico das suas operações.">
      <template #actions>
