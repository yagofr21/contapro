...
<template>
  ...
  <AuthenticatedLayout>
    <section class="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
      <div><p class="text-xs font-semibold uppercase tracking-[0.2em] text-brand-600">Agenda</p><h1 class="mt-2 text-3xl font-bold tracking-tight">Agenda e projecao</h1><p class="mt-2 text-sm text-stone-500 dark:text-slate-400">Proximos {{ horizonDays }} dias de lancamentos previsiveis.</p></div>
