...
defineProps<{ types: Option[]; currencies: Option[] }>();
</script>
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <p class="mt-2 text-sm text-stone-500 dark:text-slate-400">Cadastre o ponto de partida para organizar seus lancamentos.</p>
    <AccountForm :types="types" :currencies="currencies" />
  </AuthenticatedLayout>
</template>
