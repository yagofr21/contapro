...
<template>
  ...
  <AuthenticatedLayout>
    <PageHeader kicker="Entrada assistida" title="Importacoes CSV" subtitle="Confira cada linha antes de alterar seus dados. Arquivos originais nao ficam armazenados.">
      <template #actions>
    ...
    <template v-if="batch">
      ...
      <Card class="mt-4" title="Conferencia por linha" subtitle="Exibindo ate 200 das {{ batch.summary.total }} linhas.">
