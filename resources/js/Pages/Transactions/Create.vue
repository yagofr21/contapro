...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <h1 class="mt-2 text-3xl font-bold tracking-tight">Novo lançamento</h1>
    ...
    <div v-else class="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800 dark:border-amber-900 dark:bg-amber-950/50 dark:text-amber-200">Cadastre uma conta antes de criar lançamentos. <Link :href="route('accounts.create')" class="font-bold underline">Criar conta</Link></div>
